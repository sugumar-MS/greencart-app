        ...
        <div className="mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button
                            ...
                            className="w-full py-3.5 bg-primary text-white hover:bg-primary-dull"
                        >
                            Buy now
                        </button>
                    </div>
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                <button
                    ...
                    className='mx-auto my-16 border rounded px-12 py-2.5 text-primary hover:bg-primary/10'
                >
                    See more
                </button>
            </div>
